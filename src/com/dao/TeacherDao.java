...
public class TeacherDao {
	...
	public List<TeacherBean> GetList(String strwhere,String strorder){
		...
		try{
			...
			while(rs.next()){
				...
				cnbean.setTeacher_Gender(rs.getString("Teacher_Gender"));
	...
	public void Add(TeacherBean cnbean){
		...
		sql+="Teacher_Username,Teacher_Password,Teacher_Name,Teacher_Gender,Teacher_Tel";
		sql+=") values(";
		sql+="'"+cnbean.getTeacher_Username()+"','"+cnbean.getTeacher_Password()+"','"+cnbean.getTeacher_Name()+"','"+cnbean.getTeacher_Gender()+"','"+cnbean.getTeacher_Tel()+"'";
		sql+=")";
		Statement stat = null;
		ResultSet rs = null;
		Connection conn = new DBHelper().getConn();
	...
	public void Update(TeacherBean cnbean){
		...
		sql+="Teacher_Gender='"+cnbean.getTeacher_Gender()+"',";
