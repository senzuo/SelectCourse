      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">修改学号信息</td>
            </tr>
            <tr>
              ...
              <form name="form1" method="post" action="StudentUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="67%"><input name="student_ID" type="text" class="noshow" id="Course_ID" value="<s:property value='cnbean.student_ID'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>学号：</td>
                    <td><input name="student_Num" type="text" class="text2" id="student_Num" value="<s:property value='cnbean.student_Num'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>密码：</td>
                    <td><input name="student_Pwd" type="text" class="text2" id="student_Pwd" value="<s:property value='cnbean.student_Pwd'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>班级：</td><!-- 
                    <td><input name="student_Class" type="text" class="text2" id="student_Pwd" value="<s:property value='cnbean.student_Class'/>"></td>
                   -->
                    <td align="left">
              	    <select name="student_Class" id="list">
                  ...
                  <tr>
                    ...
                    <td><input name="student_Gender" type="text" class="text2" id="student_Gender" value="<s:property value='cnbean.student_Gender'/>"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
