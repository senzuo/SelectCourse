            ...
            <tr>
              ...
              <form name="form1" method="post" action="StudentManager.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="28%" height="30" style="padding-left:20px;"> 功能导航： <a href="StudentAdd.action">添加 </a></td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      <td height="25" align="center">${student_Num}</td>
                      <td>${student_Class}</td>
                      <td>${student_Name}</td>
                      <td>${student_Gender}</td>
                      <td align="center">
                        <a href="StudentUpdate.action?student_ID=${student_ID}">修改学号信息</a> 
                        <a href="StudentDel.action?student_ID=${student_ID}" onClick="return confirm('确定要删除该学号吗？')">删除学号</a>
