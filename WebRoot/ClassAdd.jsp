        ...
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="ClassAddSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>序号：</td>
                    <td><input name="cid" type="text" class="text2" id="cid"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>班级名称：</td>
                    <td><input name="cName" type="text" class="text2" id="cName"></td>
                  </tr>
